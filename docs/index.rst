...
.. grid:: 1 1 2 2
   ...
   .. grid-item-card:: :doc:`Tutorial </index>`
      :link: tutorial/index
      :link-type: doc
...
`Get support <https://askubuntu.com/>`_
  Ask Ubuntu is a question and answer site for Ubuntu users and developers.

`Join our online chat <https://web.libera.chat/gamja/?channels=%23channel>`_
  Meet us in `#channel` on IRC Libera.Chat.

`Report bugs <https://github.com/canonical/repo/issues/new>`_
  We want to know about the problems so we can fix them.

`Contribute docs <https://github.com/canonical/repo>`_
